...
files = os.listdir(path)
files = ["archiva", "cassandra", "errai", "flink", "groovy", "hbase", "hibernate", "jboss-transaction-manager", "kafka", "maven", "resteasy", "spark", "switchyard", "zookeeper"]
# "jbehave", "jbpm"
# files = ["hbase", "hive", "lucene"]
print(";MAP;MRR;Top 1;Top 5;Top 10")
for file in files[:]:
    print(file, end=" ")
    filePath = path+"\\"+file + ".sqlite3"
